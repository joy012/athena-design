        ...
        <section className='text-center plans-bg'>
            ...
            <div className='container mt-5'>
                <div className='row '>
                    <div className='col-md-4 '>
                        <div className='px-3'>
                            ...
                            >
                                ...
                                <p>24/7 Support</p>
                                <button className='btn plans-btn' id='plan1Btn'>
                                    {' '}
                                    Order Now{' '}
                                </button>
                            </div>
                    ...
                    <div
                        className='col-md-4'
                        onMouseOver={() => visibleBtn('plan2Btn')}
                    ...
                    >
                        <div className='px-3'>
                            <div className='plans-cards p-5'>
                                ...
                                <p>24/7 Support</p>
                                <button className='btn plans-btn' id='plan2Btn'>
                                    {' '}
                                    Order Now{' '}
                                </button>
                            </div>
                    ...
                    <div
                        className='col-md-4'
                        onMouseOver={() => visibleBtn('plan3Btn')}
                    ...
                    >
                        <div className='px-3'>
                            <div className='plans-cards p-5'>
                                ...
                                <p>24/7 Support</p>
                                <button className='btn plans-btn' id='plan3Btn'>
                                    {' '}
                                    Order Now{' '}
                                </button>
                            </div>
